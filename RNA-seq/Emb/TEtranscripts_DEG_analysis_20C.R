...
# Choose the files 
TEcounts = read_table("./6_TEtranscripts/fbxa215_TEtranscripts_20oC.cntTable")
...
write.table(TEs_DESeq2_normCounts, file = "TEtranscripts_DESeq2_normCounts.txt", quote = FALSE,
