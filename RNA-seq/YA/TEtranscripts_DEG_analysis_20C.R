...
# Choose the files 
TEcounts = read_table("./data/9_TEtranscripts_unstranded_norep4.25oC/fbxa215_TEtranscripts_withoutrep4_20oC.cntTable")
...
write.table(TEs_DESeq2_normCounts, file = "TEtranscripts_DESeq2_normCounts_YA_20C.txt", quote = FALSE,
